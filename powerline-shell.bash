...
__ps_main() {
  ...
  __ps_ps1() {
    if [ $? -eq 0 ]; then
      PS1="$(__ps_exit_status $__ps_color_bg_exit_zero)"
    else
      PS1="$(__ps_exit_status $__ps_color_bg_exit_nonzero)"
    fi
